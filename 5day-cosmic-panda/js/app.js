...
function createCloud() {
  ...
  for( let j = 0; j < 5 + Math.round(Math.random() * 10); j++ ) {
    ...
    if (x === 1) {
      cloud.setAttribute('src', 'https://image.ibb.co/g4zN70/cloud.png');
    } else if (x === 2) {
      cloud.setAttribute('src', 'https://image.ibb.co/jNWPLL/cloud2.png');
    } else {
      cloud.setAttribute('src', 'https://image.ibb.co/dCKuLL/cloud3.png');
    }
...
function addPanda() {
  ...
  randomCloud.setAttribute('src', 'https://image.ibb.co/jD3tEf/panda.png');
